...
Heroi.prototype={ 
    ...
    atualizar:function(){ 
        ...
        if(this.teclado.pressionada(SETA_BAIXO) && this.y < this.context.canvas.height - 50){ 
    ...
    atirar: function(){ 
        ...
        if(this.teclado.pressionada(SETA_ESQUERDA) && this.teclado.pressionada(SETA_CIMA)){
            tiro.velocidadeX= -20;
            tiro.velocidadeY= -20;
        }
           else if(this.teclado.pressionada(SETA_ESQUERDA) && this.teclado.pressionada(SETA_BAIXO)){
            tiro.velocidadeX= -20;
            tiro.velocidadeY= 20;
        }
          else if(this.teclado.pressionada(SETA_DIREITA) && this.teclado.pressionada(SETA_CIMA)){
            tiro.velocidadeX= 20;
            tiro.velocidadeY= -20;
        }
          else if(this.teclado.pressionada(SETA_DIREITA) && this.teclado.pressionada(SETA_BAIXO)){
            tiro.velocidadeX= 20;
            tiro.velocidadeY= 20;
        }
